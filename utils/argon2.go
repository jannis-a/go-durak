...
var (
	ErrArgon2InvalidHash         = errors.New("the encoded hash is not in the correct format")
	ErrArgon2IncompatibleVersion = errors.New("incompatible version of argon2")
)
...
func Argon2Hash(password string, p *Argon2Params) (encodedHash string, err error) {
...
func Argon2Verify(password, encodedHash string) (match bool, err error) {
